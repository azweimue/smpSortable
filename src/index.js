...
import kuiSortable from 'kendo-ui-core/js/kendo.sortable.js';
import React from 'react';
import ReactDOM from 'react-dom';
import deepDiff from 'deep-diff';

// create a React component, that is a wrapper for a Kendo UI widget
const KendoSortable = React.createClass({
	...
	componentDidMount: function() {
		...
		this.widgetInstance = new kuiSortable.ui.Sortable(elementNode,this.props.options);
